...
|     advanced      | 是否启用简单的超文本编辑语言，与对话框的用法略微相同。<br />写false或true。<br />当此项写true，且arrangementMode写0或2时，属性text可以写一些转义字符。<br />需要先注意的是，以下方法中的默认值均是该功能对应属性的值。<br />包括原生的：\V[n]，\N[n]，\P[n]，\G，\C[n]，\I[n]，\}，\{，\\\\<br />扩展的：<br />\\TC[n]：修改文字颜色，n为十六进制颜色，例如：\\TC[#ff0000]<br />\\FS[n]：修改文字大小，n为字号，例如：\\FS[24]<br />\\OC[n]：修改描边颜色，n为十六进制颜色，例如：\\OC[#ff0000]<br />\\OW[n]：修改文字描边厚度，n为厚度，例如：\\OW[2]<br />\\FF[n]：修改文字字体，n为字体名。<br />\\FI[n]：设置文字是否斜体，n写0代表无斜体，写1代表斜体。<br />\\FB[n]：设置文字是否加粗，n写0代表不加粗，1代表加粗。 |                 false                  |   true    |
